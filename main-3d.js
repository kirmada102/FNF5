...
function showIntroLetter() {
  ...
  overlayContent.innerHTML = `
    ...
    ">
      ...
      <p><strong>Controls:</strong>  W A S D keys or Arrow keys to move, Space to jump, Mouse to look.
      If you play on phone then just use the touch keys. 
      (I'd recommend to play on Laptop with headphones)</p>

      <p>This game consists of 2 levels. If you clear both of them and collect all the 
      hearts then you will recieve a big gift at the end.</p>

      <p><strong>Rules -</strong><br>
      Collect all the hearts Specially in level 1 - make sure u first collect the hearts in the field  
      and at then the last one in your favourite bakery.<br>
      Love me forever and ever and ever.</p>

      <p>You are advised to agree the follow:</p>

      <label style="display:block;margin:8px 0;">
        <input type="checkbox" class="intro-check"> i love the developer with all my heart.
      </label>
      <label style="display:block;margin:8px 0;">
...
I hope you love my small gift that i have working on for months.
